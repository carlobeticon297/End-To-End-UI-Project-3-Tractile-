...
describe(
  ...
  () => {
    ...
    it("Planning Workflow - Production Recipe", () => {
      ...
      recipePlanningPayload.name = "ETE Production Recipe";
      recipePlanningPayload.type = "production";
    ...
    it("Production Workflow - Production Recipe", () => {
      recipePlanningPayload.name = "ETE Production Recipe";
      cy.wait(5000);
      cy.step(
