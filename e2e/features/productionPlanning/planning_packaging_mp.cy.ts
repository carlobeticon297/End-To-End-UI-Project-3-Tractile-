...
describe(
  ...
  () => {
    ...
    it("Planning Workflow - Packaging Recipe", () => {
      cy.step("seed packaging recipe");
      ...
      recipePlanningPayload.name = "ETE Packaging Recipe";
      recipePlanningPayload.type = "packaging";
      ...
      cy.wait(2000);
      cy.step("User navigates to **Packaging** filter tabs");
    ...
    it("Production Workflow - Packaging Recipe", () => {
      recipePlanningPayload.name = "ETE Packaging Recipe";
      cy.wait(5000);
      cy.step(
